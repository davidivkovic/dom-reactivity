...
import { usePathname, useQuery, navigateTo, effect } from 'dom-reactivity'
    ...
    <dl class="mb-8" key={option.id}>
      ...
      <dd class="flex flex-wrap gap-3">
        {option.values.map((value) => {
          ...
          const isActive = () => {
            return searchParams()[optionNameLowerCase] === value
          }
          ...
          return (
            <button
              ...
              onClick={() => {
                searchParams(p => ({ ...p, ...Object.fromEntries(optionSearchParams) }))
              }}
