...
function Head() {
  return (
    <head>
      <title>dom-reactivity on the edge</title>
      <meta charset="utf-8" />
      ...
      <meta name="twitter:title" content="dom-reactivity on the edge" />
      <meta
        name="twitter:description"
        content="HTML, dynamically rendered in a city near you"
      />
      <meta name="twitter:image" content="/static/og/card.png" />
      <meta name="twitter:image:alt" content="The Vercel and dom-reactivity logos" />
    </head>
  );
}
  ...
  return (
    <svg class="card" viewBox="0 50 840 440">
      <defs>
        ...
        <symbol id="preact-logo" viewBox="0 -21 240 240">
          <image href="/static/logo.png" height="200" width="200"></image>
        </symbol>
